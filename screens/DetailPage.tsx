...
type Discover = NativeStackNavigationProp<RootStackParamList, "DetailPage">;

const DetailPage = ({ route }: { route: any }) => {
  const navigation = useNavigation<Discover>();
  ...
  return (
    <SafeAreaView className="flex-1 bg-white relative ">
      <ScrollView className="flex-1 px-4 py-6">
        ...
        <View className="space-y-2 mt-4 bg-gray-100 rounded-2xl px-4 py-2 mb-10 ">
          {data?.phone && (
          ...
          <View className="mt-4 px-4 py-4 rounded-lg bg-[#06B2BE] items-center justify-center mb-4">
